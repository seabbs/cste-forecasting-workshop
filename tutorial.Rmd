...
You can see in this plot that the data as observed in real time is right-truncated, meaning that observations at the end of the time series are incomplete or subject to revision.
...
Unfortunately, there are currently few available methods that can address this kind of reporting structure.
...
## Define a target date of interest

We first define a target date of interest. Here we use the 14th of January 2022, but you can change this to any date between the 31st of December 2021 and the 14th of January 2022 (or other dates if you have updated the `time_period` variable and the data snapshot).
