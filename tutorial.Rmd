...
> &#128161; The black dots in this plot represent the data observed in real-time, whilst the bars are the latest available data. This effect is referred to as right truncation. Another example of this was shown in the slides (**Inputs needed for nowcasting**). Having the information on previous reporting patterns allows us to fit a predictive model, instead of making assumptions about the reporting delay distribution which is what we have to do when we don't have this information.
